...
resource "aws_subnet" "private" {
  ...
  resource "aws_route_table_association" "private" { # this route table will be associated to public subnet
    count = length(var.private_subnets_cidr) # two route tables

...
resource "aws_security_group" "main" {
  ...
  ingress {
    ...
    to_port          = 9100
    protocol         = "tcp"
    cidr_blocks      = var.prometheus_block
      ...
      "Statement" : [
        {
          ...
          "Resource" : concat([
            "arn:aws:kms:us-east-1:767398130568:key/8f8138ff-f57f-49c9-90db-f99bf7dbdc08",
            "arn:aws:ssm:us-east-1:767398130568:parameter/${var.env}.${var.project_name}.${var.component}.*"
          ],var.parameters)
        },
        {
